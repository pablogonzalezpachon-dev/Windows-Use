...
This project defines a single, versatile agent named **Aris**. This agent is designed to interact with the Windows Operating System through its Graphical User Interface (GUI), file system, and shell, effectively mimicking a human user.

## Aris

The **Aris** agent acts as an autonomous operator capable of performing a wide range of tasks on a Windows machine. It leverages a suite of specialized tools to perceive the desktop state and execute actions.
